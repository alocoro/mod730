...
require_once(APPLICATION_PATH . DIRECTORY_SEPARATOR . 'modules' . DIRECTORY_SEPARATOR . 'resource' . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'Scopes_Model.php');
...
class Resource_Mapper_ScopesTable extends Resource_Mapper_Abstract {
	...
	/**
		...
		public function findAll() {
			...
			$results = array();
			foreach ($rows as $r)
				$results[] = new Resource_Model_Scopes($r->scope_id, $r->name,
																  $r->uri,
																  $r->description);
